...
in
{
  meta.maintainers = with lib.maintainers; [ bct lyndeno ];
  ...
  options = {
    services.lubelogger = {
      ...
      environmentFile = lib.mkOption {
        ...
        description = ''
          Path to a file containing extra LubeLogger config options in the systemd `EnvironmentFile`
          format. Refer to the [documentation](https://docs.lubelogger.com/Advanced/Environment%20Variables)
